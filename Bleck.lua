...
function Linux.Create(config)
    ...
    local GradientTopBar = Linux.Instance("UIGradient", {
        Parent = TopBar,
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(18, 18, 18)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(28, 28, 28))
    ...
    local BetaLabel = Linux.Instance("Frame", {
        Parent = TopBar,
        BackgroundColor3 = Color3.fromRGB(30, 30, 30),
        Size = UDim2.new(0, 40, 0, 16),
        Position = UDim2.new(0, TitleLabel.TextBounds.X + SubtitleLabel.TextBounds.X + 15, 0, 4),
        ZIndex = 2
    })

    local BetaGradient = Linux.Instance("UIGradient", {
        Parent = BetaLabel,
        Color = ColorSequence.new({
    ...
    local function AnimateBetaGradient()
        while BetaLabel:IsDescendantOf(game) do
            TweenService:Create(BetaGradient, TweenInfo.new(2, Enum.EasingStyle.Linear), {
                Color = ColorSequence.new({
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Dropdown(config)
            ...
            local GradientDrop = Linux.Instance("UIGradient", {
                Parent = DropFrame,
                Color = ColorSequence.new({
            ...
            local function PopulateOptions()
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        ...
                        local GradientOpt = Linux.Instance("UIGradient", {
                            Parent = OptBtn,
                            Color = ColorSequence.new({
        ...
        function TabElements.Input(config)
            ...
            local GradientTextBox = Linux.Instance("UIGradient", {
                Parent = TextBox,
                Color = ColorSequence.new({
